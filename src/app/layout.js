            ...
            <div className="flex flex-row gap-18 justify-center items-start border-b-1 border-solid border-gray-700 py-10">
              <section className="w-lg ">
                ...
                <p className="text-white py-3">
                  Plataforma especializada en gestion de PQR/S para proveedores
                  de servicios de internet en Colombia. Cumplimos con la
                  Resolucion CRC 6242 de 2021.
                </p>
                <p className="text-emerald-300">
                  Certifico de CRC 6242 de 2021
                </p>
              </section>
